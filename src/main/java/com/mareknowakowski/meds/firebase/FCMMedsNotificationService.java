package com.mareknowakowski.meds.firebase;
...
@Service
public class FCMMedsNotificationService {
    private Logger logger = LoggerFactory.getLogger(FCMMedsNotificationService.class);
